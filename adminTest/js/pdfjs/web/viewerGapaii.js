...
function configure(PDFJS) {
  ...
  PDFJS.workerSrc = 'http://localhost/gestedit/admin/js/pdfjs/build/pdf.worker.js';
...
"use strict";
var DEFAULT_URL = 'http://gapai.univ-paris8.fr/gestedit/admin/js/pdfjs/web/iste.pdf';
;
