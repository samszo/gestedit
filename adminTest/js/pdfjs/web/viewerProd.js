...
function configure(PDFJS) {
  ...
  PDFJS.workerSrc = 'http://lyorbgkp.preview.infomaniak.website/admin/js/pdfjs/build/pdf.worker.js';
...
"use strict";
var DEFAULT_URL = 'http://lyorbgkp.preview.infomaniak.website/admin/js/pdfjs/web/iste.pdf';
;
